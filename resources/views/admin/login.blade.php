...
<head>
    ...
    <link href="{{ asset('admin_assets/css/pages/login/classic/login-3.css') }}" rel="stylesheet" type="text/css" />
    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="login login-3 login-signin-on d-flex flex-row-fluid" id="kt_login">
            <div class="d-flex flex-center bgi-size-cover bgi-no-repeat flex-row-fluid"
                style="background-image: url({{ asset('admin_assets/media/bg/bg-1.jpg') }});">
                <div class="login-form text-center text-white p-7 position-relative overflow-hidden">
                    <!--begin::Login Header-->
                    {{-- <div class="d-flex flex-center mb-15">
                        <a href="#">
                            <img src="{{ asset('admin_assets/media/logos/logo-letter-9.png') }}" class="max-h-100px"
                                alt="" />
                        </a>
                    </div> --}}
                    <!--end::Login Header-->
                    ...
                    <div class="login-signin">
                        ...
                        <form class="form" action="" method="post">
                            ...
                            <div class="form-group">
                                <input
                                    class="form-control h-auto text-white placeholder-white opacity-70 bg-dark-o-70 rounded-pill border-0 py-4 px-8 mb-2"
