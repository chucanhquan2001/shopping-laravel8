...
@section('main')
    <div class="row">
        <div class="col-md-12">
            <form action="{{ route('product-variant.store') }}" method="post" role="form" enctype="multipart/form-data">
                @csrf
                <input type="text" name="product_id" value="{{ $idProduct }}" hidden>
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <img src="{{ asset('images/images.png') }}" id="blah" alt=""
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control role_select_choose @error('role') is-invalid @enderror"
                                    ...
                                    @foreach (App\Models\VariantValue::where('variant_id', $variantItem->id)->get() as $valueItem)
                                        <option value="{{ $valueItem->id }}">{{ $valueItem->value }}</option>
                                    @endforeach
                                </select>
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        <a href="{{ route('product-variant.index', $idProduct) }}" class="btn btn-danger">Back</a>
                    </div>
                </div>
            </form>
        </div>
