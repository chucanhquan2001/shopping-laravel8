                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-control @error('active') is-invalid @enderror">
                                ...
                                <input type="radio" name="active" value="{{ config('common.active.lock') }}" @if ($data->active == config('common.active.lock')) {{ 'checked' }} @endif>
                                &nbsp;&nbsp;
                                <label class="form-check-label" for="inlineRadio1">Active</label>
                                <input type="radio" name="active" value="{{ config('common.active.active') }}" @if ($data->active == config('common.active.active')) {{ 'checked' }} @endif>
                            </div>
                            ...
                            <select class="form-control role_select_choose @error('role') is-invalid @enderror"
                                ...
                                @foreach ($roles as $roleItem)
                                    <option value="{{ $roleItem->id }}"
                                        {{ $data->getRoles->contains('id', $roleItem->id) ? 'selected' : '' }}>
